...
const debug = require('debug')('bear:graph:schema');
...
const decorateWithHooks = (schema, hooks) => forEachField(schema, (field, typeName, fieldName, isResolveType = false) => {
    ...
    field.resolve = (obj, args, context, info) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(pre.map((pre) => pre(obj, args, context, info)));
        // Resolve the field.
        let result = yield resolve(obj, args, context, info);
        // Insure all post hooks after we've resolved the field with the result
        // passed in as the fifth argument.
        return yield post.reduce((result, post) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (post.length === 5) {
                return yield post(obj, args, context, info, result);
            }
            // Wait for the post hook to finish.
            yield post(obj, args, context, info);
